...
function selectTabAndScroll(href) {
    ...
    var targetTab = document.getElementById(href.substring(1, href.length)).closest('.ui-tabs-panel');
    var targetTabId = targetTab.id;
    var targetTabAriaLabel = targetTab.attributes["aria-labelledby"].value;
...
$(document).ready(function() {
    ...
    // $('.org-src-container').click(function() {
...
function togglePanel(e) {
    ...
    var slidePos =
        $("#left-panel-button").css("left") == "-23px"? '230px': '-23px';
...
$(function() {    
    ...
    //var content = $( "#content" ).load( "/public_html/index.html" );
/*
    $.ajax({url: "/public_html/index.html", success: function(result){
        $("#content").html(result);
...
*/
    $('<ul id="joesNotes"></ul>').appendTo('#left-panel-contents');
    $( "#joesNotes" ).load( "/public_html/JoesNotes.html" );

    $('#joesNotes').before('<b>Joe\'s Notes</b>');
/*
    $('#joesNotes').append(
    `
    <ul>
    <li>General   
        <ul>     
        <li><a href="/public_html/General/Allgemeine Notizen.html">Allgemeine Notizen</a></li>
        <li><a href="/public_html/General/TODO List.html">TODO List</a></li>
        </ul>
    </li>
    </ul>
    `);
...
function gotoSearchPage() {
    var url = "https://" + window.location.host + "/public_html/search.html";
...
function orgDefkey(e) {
    ...
    switch (actualkey) {
        ...
        case "c": // copy to clipboard
            // $(this).parent().parent().find('.src').text()
            copyToClipboard("hello joe");
            break;              
    }
}
